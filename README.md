...
![npm](https://img.shields.io/npm/v/@smals-belgium/shared-pseudo-tools-js)
![license](https://img.shields.io/npm/l/@smals-belgium/shared-pseudo-tools-js)
![build](https://img.shields.io/github/actions/workflow/status/smals-belgium/shared-pseudo-tools-js/build.yml)
